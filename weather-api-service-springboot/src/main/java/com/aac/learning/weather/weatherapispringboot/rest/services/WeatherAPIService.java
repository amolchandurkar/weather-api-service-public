...
public class WeatherAPIService {
  ...
  private static final ServiceLogger LOGGER =
      ServiceLoggerFactory.getServiceLogger(LoggerFactory.getLogger(WeatherAPIService.class));
  ...
  public ForecastResponse getWeatherForecast(String city) {
    ...
    LOGGER.info(
        new LogBuilder(LoggingEvent.EVENT_FORECAST, LoggingEvent.STEP_FORECAST_RESPONSE_RECEIVED)
