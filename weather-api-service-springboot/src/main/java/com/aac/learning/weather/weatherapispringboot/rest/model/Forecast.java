...
public class Forecast {
    ...
    public Forecast(long date, Main main, List<Weather> weather, Clouds clouds, Wind wind, long visibility, long pop, SystemDetail systemDetail, String dateTxt, String forecastSummary) {
        this.date = date;
        this.main = main;
